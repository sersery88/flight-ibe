...
export async function getPriceMatrix(request: PriceMatrixRequest): Promise<PriceMatrixResponse> {
  return apiClient.post<PriceMatrixResponse>('/price-matrix', request);
}
...
import type { FlightDatesResponse } from '@/types/flight';

export async function getFlightDates(
  origin: string,
  destination: string
): Promise<FlightDatesResponse> {
  return apiClient.get<FlightDatesResponse>('/flight-dates', { origin, destination });
}

// ============================================================================
// Stub Types (TODO: Complete implementation)
// ============================================================================
